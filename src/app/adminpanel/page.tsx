  ...
  return (
    <section className={styles.usersPage}>
      ...
      <header className={styles.pageHeader}>
        <div><p className={styles.eyebrow}>Управление платформой</p><h1>Пользователи</h1><p>Всего найдено: {users.length}</p></div>
      </header>
      <form className={styles.searchForm} method="get">
        <input aria-label="Поиск пользователей" defaultValue={search} name="q" placeholder="Имя, email или телефон" type="search" />
